...
CREATE TABLE "new_courses" (
    ...
    "showComingSoon" BOOLEAN NOT NULL DEFAULT false,
    "comingSoonImage" TEXT,
    "allowCurriculumPreview" BOOLEAN NOT NULL DEFAULT false,
    "metaTitle" TEXT,
    "metaDescription" TEXT,
    "metaKeywords" TEXT,
    "fakeEnrollmentCount" INTEGER,
    ...
    "defaultEnrollmentDurationDays" INTEGER,
