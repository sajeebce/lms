...
| STUDENT_MANAGEMENT_IMPLEMENTATION_PLAN.md | Student lifecycle + `/students` UI plan | Implementing Student Management module |
| DEVICE_SECURITY_AND_ACTIVE_DEVICE_IMPLEMENTATION.md | Device limits, fingerprinting, Active Device modal | Implementing secure device control |
