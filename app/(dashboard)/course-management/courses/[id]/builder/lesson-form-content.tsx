...
export function LessonFormContent({
  ...
  const [videoSource, setVideoSource] = useState<
    "youtube" | "vimeo" | "url" | "upload" | "vdocipher"
  >("youtube");
  ...
  useEffect(() => {
    if (editingLesson) {
      ...
      // Detect video source from lessonType
      if (editingLesson.lessonType === "VIDEO_YOUTUBE") {
        setVideoSource("youtube");
      } else if (editingLesson.lessonType === "VIDEO_VIMEO") {
        setVideoSource("vimeo");
      } else if (editingLesson.lessonType === "VIDEO_VDOCIPHER") {
        setVideoSource("vdocipher");
      } else if (editingLesson.lessonType === "VIDEO_URL") {
        setVideoSource("url");
      } else if (editingLesson.lessonType === "VIDEO_UPLOAD") {
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
        ...
        <div className="border-t pt-6">
          ...
          {lessonType === "VIDEO_YOUTUBE" && (
            <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      ...
                      <span className="text-sm font-medium">VdoCipher</span>
                    </Label>
                  </div>
                  <div>
                    <RadioGroupItem
              ...
              {videoSource !== "upload" && videoSource !== "vdocipher" && (
                <FormField
                  control={form.control}
                  name="videoUrl"
                  render={({ field }) => (
              ...
              {videoSource === "vdocipher" && (
                <div className="space-y-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>VdoCipher Video ID *</FormLabel>
                        <FormControl>
                          <Input
                        ...
                        <FormDescription>
                          The unique video ID from your VdoCipher dashboard
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <div className="p-4 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                    <p className="text-sm text-blue-900 dark:text-blue-100">
                      <strong>Note:</strong> VdoCipher OTP and playback info
                      will be generated automatically when the lesson is
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    <FormLabel className="text-base">Mark as Preview</FormLabel>
                    <FormDescription>
        ...
        <div className="flex justify-end gap-3 pt-4 border-t">
          ...
          <Button
            type="submit"
            disabled={isPending || uploading}
            className="w-full sm:w-auto bg-linear-to-r from-violet-600 to-indigo-600 hover:from-violet-700 hover:to-indigo-700 text-white font-medium"
          >
            {isPending || uploading
              ? "Saving..."
              : isEditing
