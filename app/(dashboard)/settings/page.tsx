  ...
  const settingsCategories = [
    {
      ...
      description:
        "Institute name, logo, signature, currency, and country settings",
      icon: Building2,
    ...
    },
    {
      ...
      description:
        "Configure academic setup including cohorts and enrollment modes",
      icon: BookOpen,
    ...
    },
    {
      ...
      description:
        "Configure payment gateways (Stripe, PayPal, Razorpay, etc.)",
      icon: CreditCard,
    ...
    {
      title: "Video Player Setting",
      description:
        "Control how YouTube and VdoCipher behave across your lessons",
      icon: Video,
      href: "/settings/video-player",
      color: "from-emerald-500 via-cyan-500 to-fuchsia-500",
      bgColor: "from-emerald-50 via-cyan-50 to-fuchsia-50",
    },
    {
          ...
          return (
            ...
            >
              ...
              <div className="flex items-start gap-4">
                <div
                  className={`p-3 rounded-xl shadow-md bg-gradient-to-br ${category.color}`}
                >
