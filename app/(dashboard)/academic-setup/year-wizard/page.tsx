export default function YearWizardPage() {
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-neutral-200 p-8 text-center">
        <p className="text-neutral-600">Year Wizard page - To be implemented</p>
        <p className="text-sm text-neutral-500 mt-2">
          Stepper-style interface for bulk cohort/section generation
        </p>
      </div>
    </div>
  )
