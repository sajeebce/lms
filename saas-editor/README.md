# SaaS Rich Text Editor Snapshot

This `saas-editor` folder is a **snapshot** of the LMS rich text editor so you can turn it into a separate SaaS product later without touching the main LMS code.
...
1. In VS Code, you can **open just this folder**:
   - `File → Open Folder... → saas-editor`
2. Later you can move/copy `saas-editor` into a **new repo** and add your own:
   - `package.json`
...
- Changes you make in `saas-editor` **will NOT affect** the LMS, unless you intentionally point imports back to LMS code.
